      ...
      <main class="main-content">
        ...
        <section class="card table-card">
          ...
          <div class="table-scroll">
            <table>
              <thead><tr><th>Name</th><th>Email</th><th>Phone</th><th>Covered States</th><th>Covered LGAs</th><th>Joined</th><th>Actions</th></tr></thead>
              <tbody>
                @forelse($staff as $row)
                  <tr>
                    ...
                    <td style="font-size:0.8rem; color:var(--text-soft);">{{ count($row->staffLgas()) > 0 ? implode(', ', $row->staffLgas()) : 'All' }}</td>
