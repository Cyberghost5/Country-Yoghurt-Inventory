...
<html lang="en">
  <head>
    ...
    <title>Add Customer - Country Yoghurt</title>
      ...
      <main class="main-content">
        <header class="topbar">
          <div class="title-block">
            <h2>Add Customer</h2>
            <p>Create customer accounts using the standard dashboard workflow.</p>
          </div>
        ...
        <section class="card form-card">
          ...
          <form method="POST" action="{{ route('users.store.customer') }}" class="dashboard-form" novalidate>
            @csrf
