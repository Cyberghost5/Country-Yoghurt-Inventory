...
<html lang="en">
  <head>
    ...
    <title>Add Super Admin - Country Yoghurt</title>
    ...
    <div class="app-shell">
      ...
      <main class="main-content">
        ...
        <section class="card form-card">
          ...
          <form method="POST" action="{{ route('users.store.super_admin') }}" class="dashboard-form" novalidate>
            @csrf
            ...
            <div class="form-actions-row">
              <button type="submit" class="primary-btn">Create Super Admin</button>
            </div>
          </form>
        </section>
      </main>
